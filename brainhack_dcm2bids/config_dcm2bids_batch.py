...
dicomdir = os.path.join("/Users/kristadestasio/Desktop/open_neuroscience_workshop/data/dicoms")
codedir = os.path.join("/Users/kristadestasio/Desktop/open_neuroscience_workshop/brainhack_dcm2bids")  # Contains subject_list.txt, config file, and dcm2bids_batch.py
...
niidir = os.path.join("/Users/kristadestasio/Desktop/open_neuroscience_workshop/data/bids_data") # Where the niftis will be put
